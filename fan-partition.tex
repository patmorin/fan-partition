...
\begin{proof}
  ...
  To do this, we make use of the following property of $t$-trees \cite{kundgen.pelsmajer:?}: For any integer $s$, the set $N_C$ of vertices in $L_{s}$ that are adjacent to a single component $C$ of $H[L_{s+1}]$ form a clique in $H$.
