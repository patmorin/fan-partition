...
\begin{lem}
  For every integer $k\in\{1,\ldots,n\}$, the metric space $\mathcal{M}^*:=(V(G),d^*)$ has a $(k,O(\sqrt{\log n}))$-volume-preserving Euclidean embedding. \pat{Check quantifier on $k$}
\end{lem}
