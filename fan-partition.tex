...
\Cref{sparsifier_simple} is a consequence of the following stronger technical lemma, which says that after removing the vertices of $X$, the subgraph of $G$ induced by $\ell$ consecutive layers of $H\boxtimes P-X$ has components of size at most $?tn/D$.
