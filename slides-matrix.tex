...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item Take $D=n/\log n$, so $|X|\in O(n\log^2 n)$ and $\bw(G-X)\in O(n\log^2 n)$.
...
\begin{frame}
  ...
  \begin{center}
  \only<1>{\includegraphics[page=1]{figs/techniques}}%
  \only<2>{\includegraphics[page=2]{figs/techniques}}%
  \only<3>{\includegraphics[page=3]{figs/techniques}}%
  \only<4>{\includegraphics[page=1]{figs/techniques-ii}}%
  \only<5>{\includegraphics[page=2]{figs/techniques-ii}}%
  \only<6>{\includegraphics[page=3]{figs/techniques-ii}}%
  \only<7>{\includegraphics[page=4]{figs/techniques-ii}}%
  \only<8>{\includegraphics[page=5]{figs/techniques-ii}}%
  \only<9>{\includegraphics[page=6]{figs/techniques-ii}}%
  \only<10>{\includegraphics[height=.6\textheight,page=2]{figs/product}}%
  \end{center}
\end{frame}
